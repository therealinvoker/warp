...
const TITLE_NEW_USERS: &str = "Help improve Bang.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve Bang's AI capabilities. You can opt out any time.";
