...
use crate::ai::agent::{
    ...
    ListGithubPrCommentsResult, OutputModelInfo, PassiveCodeDiffEntry, PassiveSuggestionResultType,
    PassiveSuggestionTrigger, ReadDocumentsResult, ReadFilesResult, ReadGithubIssueResult,
    ReadGithubPrResult, ReadMCPResourceResult, ReadShellCommandOutputResult,
    ReplyToPrCommentResult, RequestCommandOutputResult, RequestFileEditsResult,
