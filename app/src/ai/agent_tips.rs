...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: "<keybinding> to open the Command Palette and access Bang actions and shortcuts.".to_string(),
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or Bang Drive objects to your prompt.".to_string(),
        ...
        AgentTip {
            description: "Bangify a remote SSH session to enable Oz inside that environment.".to_string(),
        ...
        AgentTip {
            description: "`/init` to generate a `BANG.md` file and define project rules for the agent.".to_string(),
            link: Some("https://docs.warp.dev/agent-platform/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::OpenWarpDrive => Some("Bang Drive.".to_string()),
