...
pub const MODEL_SPECS_DESCRIPTION: &str = "Bang's benchmarks for how well a model performs in our harness, the rate at which it consumes credits, and task speed.";
