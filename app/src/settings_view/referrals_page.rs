...
const HEADER_TEXT: &str = "Invite a friend to Bang";
const ANONYMOUS_USER_HEADER_TEXT: &str = "Sign up to participate in Bang's referral program";
...
const REWARD_INTRO: &str = "Get exclusive Bang goodies when you refer someone*";
