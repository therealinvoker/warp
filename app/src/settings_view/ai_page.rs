...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ...
            ToggleSettingActionPair::new(
                "Computer Use PR screenshot attachments",
                builder(SettingsAction::AI(
                    AISettingsPageAction::ToggleComputerUsePrScreenshotAttachment,
                )),
                &(context.clone()
                    & id!(flags::IS_ANY_AI_ENABLED)
                    & id!(flags::COMPUTER_USE_ARTIFACT_STORAGE_FLAG)),
                flags::COMPUTER_USE_PR_SCREENSHOT_ATTACHMENT_FLAG,
            )
            .with_group(bindings::BindingGroup::WarpAi)
            .with_enabled(|| FeatureFlag::AgentModeComputerUse.is_enabled()),
        ],
...
pub enum AISettingsPageAction {
    ...
    ToggleComputerUsePrScreenshotAttachment,
    ToggleFileBasedMcp,
        ...
        match action {
            ...
            AISettingsPageAction::ToggleComputerUseArtifactStorage => {
                PrivacySettings::handle(ctx).update(ctx, |settings, ctx| {
                    settings.set_is_computer_use_artifact_storage_enabled(
                        !settings.is_computer_use_artifact_storage_enabled,
                        ctx,
                    );
                });
                ctx.notify();
            ...
            AISettingsPageAction::ToggleComputerUsePrScreenshotAttachment => {
                PrivacySettings::handle(ctx).update(ctx, |settings, ctx| {
                    settings.set_is_computer_use_pr_screenshot_attachment_enabled(
                        !settings.is_computer_use_pr_screenshot_attachment_enabled,
                        ctx,
                    );
                });
                ctx.notify();
...
struct CloudAgentComputerUseWidget {
    ...
    pr_screenshot_attachment_toggle: SwitchStateHandle,
}
...
impl SettingsWidget for CloudAgentComputerUseWidget {
    ...
    fn render(
        ...
        let is_pr_screenshot_attachment_toggleable = is_computer_use_effectively_enabled
            && privacy_settings.is_computer_use_artifact_storage_enabled;
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                "Store artifacts generated by Computer Use with Warp so they can be referenced later.",
                is_computer_use_effectively_enabled,
                app,
            ))
            .with_child(build_toggle_element(
                render_body_item_label::<AISettingsPageAction>(
                    "Attach Computer Use screenshots to PRs".to_string(),
                    Some(styles::header_font_color(
                        is_pr_screenshot_attachment_toggleable,
                        app,
                    )),
                    None,
                    LocalOnlyIconState::Hidden,
                ...
                render_ai_feature_switch(
                    self.pr_screenshot_attachment_toggle.clone(),
                    privacy_settings.is_computer_use_artifact_storage_enabled
            ...
            .with_child(render_ai_setting_description(
                "Attach screenshots from Computer Use sessions to pull requests when Warp creates or updates them.",
                is_pr_screenshot_attachment_toggleable,
                app,
            ))
            .finish()
