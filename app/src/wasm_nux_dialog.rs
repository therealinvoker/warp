...
impl View for WasmNUXDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dialog = if self.requested_download {
            Dialog::new(
                "Open in Bang Desktop?".to_string(),
            ...
            Dialog::new("Download Bang Desktop?".to_string(), None, dialog_styles)
                .with_child(
                    Flex::column()
                        ...
                        .with_child(
                            appearance
                                .ui_builder()
                                .span("Bang is the intelligent terminal with AI and your dev team's knowledge built-in.")
            ...
            let object_kind = match web_intent_parser::current_web_intent() {
                Some(WebIntent::DriveObject(_)) => "Bang Drive objects",
