...
const FEATURE_ITEMS: &[FeatureItem] = &[
    FeatureItem {
        icon: Icon::HeartHand,
        title: "Contribute",
        description: "Bang's client code is now open source. Get started by using the /feedback skill to open an issue, and follow the contribution guidelines here.",
    ...
    FeatureItem {
        ...
        description: "The Bang repo is managed by an agent-first workflow powered by Oz, our cloud agent orchestration platform.",
        inline_link: Some(InlineLink {
            text: "Oz",
            url: OZ_URL,
        }),
...
impl OpenWarpLaunchModal {
    ...
    fn render_title(appearance: &Appearance) -> Box<dyn Element> {
        Text::new("Bang is now open-source", appearance.ui_font_family(), 20.)
    ...
    fn render_description(appearance: &Appearance) -> Box<dyn Element> {
        Text::new(
            "You, our community, can participate in building Bang using an agent-first workflow.",
