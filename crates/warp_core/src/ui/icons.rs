...
pub enum Icon {
    ...
    Hash,
    FolderClosed,
    // Thin-line open/closed folder pair used for the left-nav folder headers so
    // an expanded section reads as an open folder and a collapsed one as closed.
    FolderOpen,
    FolderClosedOutline,
    FileCopy,
    Credits,
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::RightSidebarOpen => "bundled/svg/right-panel-open.svg",
            ...
            Icon::FolderOpen => "bundled/svg/folder-open.svg",
            Icon::FolderClosedOutline => "bundled/svg/folder-closed-outline.svg",
